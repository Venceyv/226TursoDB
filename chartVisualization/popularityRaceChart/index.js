...
let svg = d3.select('body').append('svg').attr('width', 960).attr('height', 600);
...
let title = svg
  ...
  .attr('class', 'title')
  .attr('y', 24)
  .html('Top Characters by Popularity (2022)');
...
d3.csv('anime_brand_values.csv').then(function (data) {
  ...
  let ticker = d3.interval((e) => {
    ...
    // yearText.html(~~year);
    yearText.html(months[currMonth]);
